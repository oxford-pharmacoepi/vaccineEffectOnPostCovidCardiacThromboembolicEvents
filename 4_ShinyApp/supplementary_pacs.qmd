---
title: "SUPPLEMENT"
subtitle: "The effectiveness of COVID-19 vaccines to prevent post COVID cardiac and thromboembolic complications: staggered cohort analyses of data from Spain, Estonia, and the UK."
format:
  docx:
...
cat("##", "(A) Main analysis, (B) Sensitivity analysis: Vaccination between COVID-19 and outcome not allowed, (C) Post COVID sequelae refers just to the first outcome after infection., (D) Follow-up ends at first vaccine dose after index date.")
